  ...
  return (
    <header
      className={`sticky top-0 z-50 transition-all duration-300 ${
        scrolled
          ? "bg-cream/90 backdrop-blur-md border-b border-line shadow-[0_1px_0_rgba(7,42,32,0.04)]"
...
<nav
      ...
      <div
        id="mobile-menu"
        className={`lg:hidden fixed inset-x-0 top-[84px] bottom-0 z-40 border-t border-line bg-cream transition-all duration-300 ${
        ...
        <div className="container-x flex h-full flex-col overflow-y-auto pt-6 pb-10">
          <div className="flex flex-col divide-y divide-line">
            {navItems.map((item, i) => (
              <a
                ...
                className="flex items-center justify-between py-4 text-[17px] font-medium tracking-tight text-ink transition-colors hover:text-forest"
              >
                {item.label}
          ...
          <div className="mt-8 border-t border-line pt-8">
            ...
            <a
              ...
              className="mt-5 block text-center font-mono text-[12px] tracking-[0.1em] text-slate"
            >
              hello@mavuno.io
            </a>
          </div>
